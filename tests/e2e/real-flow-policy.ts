...
export const REAL_FLOW_BOUNDARIES: Record<RealFlowId, RealFlowBoundary> = {
  'heygen-two-page': {
    ...
    reason:
      'requires explicit real HeyGen credentials, a capped two-page budget and Windows RC sign-off',
  ...
  'local-audio-windows-rc': {
    environment: 'M8_RUN_REAL_E2E',
    reason:
      'requires a signed Windows RC and manual audiovisual review; DG2 instead uses S1/S8 synthetic WAVs',
  ...
  'presenter-windows-rc': {
    ...
    reason:
      'requires private presenter fixtures, local ASR assets, a signed Windows RC and operator review',
    nextGate: 'DG7_OPTIONAL_FEATURES_DECIDED',
