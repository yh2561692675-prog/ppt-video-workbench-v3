...
- Preserve the M8 traceability matrix, acceptance evidence manifest and release
  freeze guard as auditable project artifacts.

## M8 RC1

- Added the V1.0 acceptance plan, fixture manifest and traceability workbook.
- Added automated local-audio and fake-HeyGen boundary checks, performance
  budgets and release-security scans.
- Added an RC1 evidence structure covering the complete package and six manual
  acceptance scenarios.
- Recorded the current release state as `pending_manual_windows`; no v1.0.0 tag
  is created until the manual sign-off is complete.
